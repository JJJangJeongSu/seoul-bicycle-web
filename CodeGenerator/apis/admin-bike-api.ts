...
/**
 * AdminBikeApi - axios parameter creator
 * @export
 */
export const AdminBikeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
/**
 * AdminBikeApi - functional programming interface
 * @export
 */
export const AdminBikeApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = AdminBikeApiAxiosParamCreator(configuration)
    return {
        /**
         * 관리자 전용. 자전거를 추가합니다. 정류장 id를 입력받습니다.
         * @summary 자전거 추가
        ...
        async createBike(stationId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateBike201Response>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['AdminBikeApi.createBike']?.[localVarOperationServerIndex]?.url;
        ...
        async deleteBike(bikeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Success>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminBikeApi.deleteBike']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 관리자 전용. 전체 자전거 목록을 조회합니다. 검색 및 페이지네이션을 지원합니다.
        ...
        async getAllBikesAdmin(page?: number, limit?: number, searchId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetAllBikesAdmin200Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminBikeApi.getAllBikesAdmin']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 관리자 전용, 특정 자전거의 정보만을 조회
        ...
        async getBikeAdmin(bikeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetBikeAdmin200Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminBikeApi.getBikeAdmin']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 관리자 전용. 특정 자전거의 렌탈 내역을 조회합니다. 정렬 및 페이지네이션을 지원합니다.
        ...
        async getBikeRentalRecords(bikeId: string, page?: number, limit?: number, sortBy?: GetBikeRentalRecordsSortByEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetBikeRentalRecords200Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminBikeApi.getBikeRentalRecords']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 관리자 전용. 대여소 정보를 수정합니다.
        ...
        async updateBikeStatus(bikeId: string, status: UpdateBikeStatusStatusEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateBikeStatus200Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AdminBikeApi.updateBikeStatus']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * AdminBikeApi - factory interface
 * @export
 */
export const AdminBikeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = AdminBikeApiFp(configuration)
    return {
        /**
         * 관리자 전용. 자전거를 추가합니다. 정류장 id를 입력받습니다.
         * @summary 자전거 추가
...
/**
 * AdminBikeApi - object-oriented interface
 * @export
 * @class AdminBikeApi
 * @extends {BaseAPI}
 */
export class AdminBikeApi extends BaseAPI {
    /**
     * 관리자 전용. 자전거를 추가합니다. 정류장 id를 입력받습니다.
     * @summary 자전거 추가
     * @param {string} stationId 정류장 번호
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AdminBikeApi
     */
    public createBike(stationId: string, options?: RawAxiosRequestConfig) {
        return AdminBikeApiFp(this.configuration).createBike(stationId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteBike(bikeId: string, options?: RawAxiosRequestConfig) {
        return AdminBikeApiFp(this.configuration).deleteBike(bikeId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAllBikesAdmin(page?: number, limit?: number, searchId?: string, options?: RawAxiosRequestConfig) {
        return AdminBikeApiFp(this.configuration).getAllBikesAdmin(page, limit, searchId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getBikeAdmin(bikeId: string, options?: RawAxiosRequestConfig) {
        return AdminBikeApiFp(this.configuration).getBikeAdmin(bikeId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getBikeRentalRecords(bikeId: string, page?: number, limit?: number, sortBy?: GetBikeRentalRecordsSortByEnum, options?: RawAxiosRequestConfig) {
        return AdminBikeApiFp(this.configuration).getBikeRentalRecords(bikeId, page, limit, sortBy, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateBikeStatus(bikeId: string, status: UpdateBikeStatusStatusEnum, options?: RawAxiosRequestConfig) {
        return AdminBikeApiFp(this.configuration).updateBikeStatus(bikeId, status, options).then((request) => request(this.axios, this.basePath));
    }
}
