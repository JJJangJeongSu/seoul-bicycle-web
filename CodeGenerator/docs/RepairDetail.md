...
**reporterInfo** | [**RepairDetailAllOfReporterInfo**](RepairDetailAllOfReporterInfo.md) |  | [optional] [default to undefined]

## Example

```typescript
import { RepairDetail } from './api';

const instance: RepairDetail = {
    id,
    type,
    bikeId,
    stationId,
