...
------------ | ------------- | ------------- | -------------
**startStation** | [**EntityStation**](EntityStation.md) |  | [default to undefined]
**endStation** | [**EntityStation**](EntityStation.md) |  | [default to undefined]
...
```typescript
import { EntityRouteInfo } from './api';

const instance: EntityRouteInfo = {
    startStation,
    endStation,
    distance,
    duration,
